<?php $__env->startSection('title', 'Créer une épreuve'); ?>
...
<div style="min-height: calc(100vh - 80px); background: #000000; padding: 2rem 0;">
    <div style="max-width: 1400px; margin: 0 auto; padding: 0 2rem;">
        ...
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 3rem;">
            ...
            <a href="<?php echo e(route('organizer.dashboard')); ?>" style="background: #1a1a1a; color: #cccccc; border: 1px solid #333333; padding: 1rem 2rem; font-family: 'Oswald', sans-serif; font-weight: 600; text-decoration: none; text-transform: uppercase; letter-spacing: 1px; transition: all 0.2s ease;">
                ← RETOUR
            </a>
        </div>
        ...
        <?php if(session('success')): ?>
            <div style="background: #0c2e1a; border-left: 4px solid #22c55e; padding: 1rem 1.5rem; margin-bottom: 2rem;">
                <p style="color: #22c55e; margin: 0; font-family: 'Oswald', sans-serif;">✓ <?php echo e(session('success')); ?></p>
            </div>
        <?php endif; ?>
        ...
        <form method="POST" action="<?php echo e(route('organizer.store')); ?>" id="create-event-form" novalidate>
            <?php echo csrf_field(); ?>
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 300px; gap: 4rem; align-items: start;">
                        ...
                        <div>
                            <div style="margin-bottom: 2rem;">
                                ...
                                <input type="text" name="name" value="<?php echo e(old('name')); ?>" required style="width: 100%; padding: 1.25rem; background: #1a1a1a; border: 1px solid #333333; color: #ffffff; font-size: 1rem; transition: all 0.2s ease;">
                            ...
                            <div style="margin-bottom: 2rem;">
                                ...
                                <textarea name="description" rows="6" style="width: 100%; padding: 1.25rem; background: #1a1a1a; border: 1px solid #333333; color: #ffffff; font-size: 1rem; resize: vertical; transition: all 0.2s ease;" placeholder="Décrivez votre épreuve, l'ambiance, les parcours..."><?php echo e(old('description')); ?></textarea>
                            </div>
                            ...
                            <div style="display: grid; grid-template-columns: 2fr 1fr; gap: 2rem; margin-bottom: 2rem;">
                                <div>
                                    ...
                                    <input type="text" name="location" value="<?php echo e(old('location')); ?>" required style="width: 100%; padding: 1.25rem; background: #1a1a1a; border: 1px solid #333333; color: #ffffff; font-size: 1rem; transition: all 0.2s ease;" placeholder="Ville">
                                </div>
                                <div>
                                    ...
                                    <input type="text" name="department" value="<?php echo e(old('department')); ?>" required maxlength="3" style="width: 100%; padding: 1.25rem; background: #1a1a1a; border: 1px solid #333333; color: #ffffff; font-size: 1rem; transition: all 0.2s ease;" placeholder="34">
                                </div>
                            </div>
                            ...
                            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2rem; margin-bottom: 2rem;">
                                <div>
                                    ...
                                    <input type="date" name="event_date" value="<?php echo e(old('event_date')); ?>" required style="width: 100%; padding: 1.25rem; background: #1a1a1a; border: 1px solid #333333; color: #ffffff; font-size: 1rem; transition: all 0.2s ease;">
                                </div>
                                <div>
                                    ...
                                    <input type="date" name="registration_deadline" value="<?php echo e(old('registration_deadline')); ?>" required style="width: 100%; padding: 1.25rem; background: #1a1a1a; border: 1px solid #333333; color: #ffffff; font-size: 1rem; transition: all 0.2s ease;">
                                </div>
                            </div>
                            ...
                            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2rem; margin-bottom: 2rem;">
                                <div>
                                    ...
                                    <input type="time" name="start_time" value="<?php echo e(old('start_time', '09:00')); ?>" style="width: 100%; padding: 1.25rem; background: #1a1a1a; border: 1px solid #333333; color: #ffffff; font-size: 1rem; transition: all 0.2s ease;">
                                </div>
                                <div>
                                    ...
                                    <input type="number" name="max_participants" value="<?php echo e(old('max_participants')); ?>" min="1" style="width: 100%; padding: 1.25rem; background: #1a1a1a; border: 1px solid #333333; color: #ffffff; font-size: 1rem; transition: all 0.2s ease;" placeholder="Ex: 500">
                                </div>
                            </div>
                            ...
                            <div style="margin-bottom: 2rem;">
                                ...
                                <select name="event_type" required style="width: 100%; padding: 1.25rem; background: #1a1a1a; border: 1px solid #333333; color: #ffffff; font-size: 1rem; transition: all 0.2s ease;">
                                    ...
                                    <option value="course" <?php echo e(old('event_type') == 'course' ? 'selected' : ''); ?>>Course à pied / Trail</option>
                                    <option value="vtt" <?php echo e(old('event_type') == 'vtt' ? 'selected' : ''); ?>>VTT / Cyclisme</option>
                                    <option value="triathlon" <?php echo e(old('event_type') == 'triathlon' ? 'selected' : ''); ?>>Triathlon</option>
                                    <option value="marche" <?php echo e(old('event_type') == 'marche' ? 'selected' : ''); ?>>Marche / Randonnée</option>
                                    <option value="autre" <?php echo e(old('event_type') == 'autre' ? 'selected' : ''); ?>>Autre</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div style="background: #1a1a1a; border: 1px solid #333333; padding: 2rem; margin-bottom: 2rem;">
                            ...
                            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2rem; margin-bottom: 2rem;">
                                <div>
                                    ...
                                    <input type="text" name="organizer_name" value="<?php echo e(old('organizer_name')); ?>" required style="width: 100%; padding: 1.25rem; background: #111111; border: 1px solid #333333; color: #ffffff; transition: all 0.2s ease;" placeholder="Nom du club ou organisation">
                                </div>
                                <div>
                                    ...
                                    <select name="organizer_type" style="width: 100%; padding: 1.25rem; background: #111111; border: 1px solid #333333; color: #ffffff; transition: all 0.2s ease;">
                                        ...
                                        <option value="club" <?php echo e(old('organizer_type') == 'club' ? 'selected' : ''); ?>>Club sportif</option>
                                        <option value="association" <?php echo e(old('organizer_type') == 'association' ? 'selected' : ''); ?>>Association</option>
                                        <option value="entreprise" <?php echo e(old('organizer_type') == 'entreprise' ? 'selected' : ''); ?>>Entreprise</option>
                                        <option value="collectivite" <?php echo e(old('organizer_type') == 'collectivite' ? 'selected' : ''); ?>>Collectivité</option>
                                        <option value="autre" <?php echo e(old('organizer_type') == 'autre' ? 'selected' : ''); ?>>Autre</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div style="margin-bottom: 2rem;">
                                ...
                                <textarea name="organizer_description" rows="3" style="width: 100%; padding: 1.25rem; background: #111111; border: 1px solid #333333; color: #ffffff; resize: vertical; transition: all 0.2s ease;" placeholder="Présentez votre organisation, son histoire, ses valeurs..."><?php echo e(old('organizer_description')); ?></textarea>
                            </div>
                            ...
                            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2rem;">
                                <div>
                                    ...
                                    <input type="url" name="organizer_website" value="<?php echo e(old('organizer_website')); ?>" style="width: 100%; padding: 1.25rem; background: #111111; border: 1px solid #333333; color: #ffffff; transition: all 0.2s ease;" placeholder="https://votre-site.com">
                                </div>
                                <div>
                                    ...
                                    <input type="text" name="organizer_social" value="<?php echo e(old('organizer_social')); ?>" style="width: 100%; padding: 1.25rem; background: #111111; border: 1px solid #333333; color: #ffffff; transition: all 0.2s ease;" placeholder="@votre_page">
                                </div>
                            </div>
                        </div>
                        ...
                        <div style="background: #1a1a1a; border: 1px solid #333333; padding: 2rem; margin-bottom: 2rem;">
                            ...
                            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2rem; margin-bottom: 2rem;">
                                <div>
                                    ...
                                    <input type="text" name="contact_name" value="<?php echo e(old('contact_name')); ?>" required style="width: 100%; padding: 1.25rem; background: #111111; border: 1px solid #333333; color: #ffffff; transition: all 0.2s ease;" placeholder="Prénom NOM">
                                </div>
                                <div>
                                    ...
                                    <input type="text" name="contact_role" value="<?php echo e(old('contact_role')); ?>" style="width: 100%; padding: 1.25rem; background: #111111; border: 1px solid #333333; color: #ffffff; transition: all 0.2s ease;" placeholder="Président, Organisateur, etc.">
                                </div>
                            </div>
                            ...
                            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2rem; margin-bottom: 2rem;">
                                <div>
                                    ...
                                    <input type="email" name="contact_email" value="<?php echo e(old('contact_email')); ?>" required style="width: 100%; padding: 1.25rem; background: #111111; border: 1px solid #333333; color: #ffffff; transition: all 0.2s ease;" placeholder="contact@exemple.com">
                                </div>
                                <div>
                                    ...
                                    <input type="tel" name="contact_phone" value="<?php echo e(old('contact_phone')); ?>" style="width: 100%; padding: 1.25rem; background: #111111; border: 1px solid #333333; color: #ffffff; transition: all 0.2s ease;" placeholder="06 12 34 56 78">
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <textarea name="contact_address" rows="3" style="width: 100%; padding: 1.25rem; background: #111111; border: 1px solid #333333; color: #ffffff; resize: vertical; transition: all 0.2s ease;" placeholder="Adresse complète de l'organisateur"><?php echo e(old('contact_address')); ?></textarea>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH U:\DEV\ats-sport\resources\views/organizer/create-event.blade.php ENDPATH**/ ?>