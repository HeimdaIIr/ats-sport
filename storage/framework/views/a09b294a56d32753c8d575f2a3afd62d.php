                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-3 mb-3">
                            <a href="<?php echo e(route('chronofront.events.index')); ?>" class="btn btn-primary w-100 py-3">
                                <i class="bi bi-plus-circle"></i><br>
                                <span class="mt-2">Nouvel événement</span>
                            </a>
                        </div>
                        <div class="col-md-3 mb-3">
                            <a href="<?php echo e(route('chronofront.entrants.import')); ?>" class="btn btn-success w-100 py-3">
                                <i class="bi bi-upload"></i><br>
                                <span class="mt-2">Import CSV</span>
                            </a>
                        </div>
                        <div class="col-md-3 mb-3">
                            <a href="<?php echo e(route('chronofront.timing.index')); ?>" class="btn btn-warning w-100 py-3">
                                <i class="bi bi-stopwatch"></i><br>
                                <span class="mt-2">Chronométrer</span>
                            </a>
                        </div>
                        <div class="col-md-3 mb-3">
                            <a href="<?php echo e(route('chronofront.results.index')); ?>" class="btn btn-info w-100 py-3 text-white">
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="<?php echo e(route('chronofront.events.index')); ?>" class="btn btn-sm btn-outline-primary">Voir tout</a>
                </div>
                <div class="card-body">
                    <template x-if="recentEvents.length === 0">
                        <div class="text-center text-muted py-4">
                            ...
                            <a href="<?php echo e(route('chronofront.events.index')); ?>" class="btn btn-sm btn-primary">Créer un événement</a>
                        </div>
                    </template>
...
<?php echo $__env->make('chronofront.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH U:\DEV\ats-sport\resources\views/chronofront/dashboard.blade.php ENDPATH**/ ?>